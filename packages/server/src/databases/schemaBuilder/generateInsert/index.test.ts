...
const categoriesTable = enrichTable({
  ...
  columns: [
    ...
    { name: "name", fieldName: "name", dataType: "nvarchar", isNullable: false, description: null },
    { name: "slug", fieldName: "slug", dataType: "nvarchar", isNullable: false, description: null },
    {
