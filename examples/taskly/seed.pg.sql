...
-- Reserved-word coverage: GROUP, ORDER and DESC are reserved in PostgreSQL,
-- MySQL and T-SQL alike, so this table only resolves if every identifier is
...
INSERT INTO "group" (id, org_id, name, "order", "desc") VALUES
